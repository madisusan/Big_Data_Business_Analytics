...
original_training_data = read.csv(file = file.path("/Volumes/DOCUMENTS/IE/Big Data/TERM 2/Machine Learning II/assignment 1/Assignment 1 full docs/R - House Prices Predictions/house-prices-advanced-regression-techniques/train.csv"))
original_test_data = read.csv(file = file.path("/Volumes/DOCUMENTS/IE/Big Data/TERM 2/Machine Learning II/assignment 1/Assignment 1 full docs/R - House Prices Predictions/house-prices-advanced-regression-techniques/test.csv"))
```
